...
MSG_NOTIFY_PROJECT_DOC_CAHNGED_ID = 30
...
MSG_NOTIFY_PROJECT_DOC_CAHNGED_ID : "Project '{0}' document added\changed."
...
def decode_json2msg( arg_str ):
    try:
        ...
        if key_type in ( MSG_NOTIFY_TYPE_ASK_ACCEPT_ID, MSG_NOTIFY_TYPE_PROJECT_CHANGED_ID, MSG_NOTIFY_PROJECT_DOC_CAHNGED_ID ):
